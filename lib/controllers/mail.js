...
exports.addMail = function(req,res) {
  ...
  exports.updateMail = function(req,res) {
    var data = req.body;
      ...
      console.log(data);
   /* db.cypherQuery("START n=NODE(" + data.mailId + ") SET n="+data.data,function(err,result){
        if(err)throw err;
        res.json(result.data);
    });*/
};
    ...
    var data = req.body;
      ...
      console.log(data);
    /*db.cypherQuery("START n=NODE(" + data.mailId + ") match (n)-[r]-() delete n,r",function(err,result){
        if(err)throw err;
        res.json(result.data);
    });*/
};
